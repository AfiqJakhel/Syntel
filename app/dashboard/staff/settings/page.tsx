                    ...
                    {activeTab === "notifications" && (
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                {[
                                    { id: "task", label: "Tugas Baru", desc: "Notifikasi saat ada instruksi baru ditugaskan", value: taskAlerts, setter: setTaskAlerts },
                                    { id: "revision", label: "Pengingat Revisi", desc: "Diingatkan saat ada permintaan revisi", value: revisionReminders, setter: setRevisionReminders },
                                ].map((item) => (
                                    <div
                                        key={item.id}
